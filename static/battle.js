...
function init(){
    ...
    ground1.style.position= 'absolute';
    ground1.style.top = '320px';
    ground1.style.zIndex = '1';
    ground1.style.left = '260px';
    ground1.style.visibility='visible';


    ground2 = document.getElementById('ground2');
    ground2.style.position= 'absolute';
    ground2.style.top = '190px';
    ground2.style.zIndex = '1';
    ground2.style.left = (window.innerWidth - 560) + 'px';
    ground2.style.visibility='visible';
